...
const PublishedProjects = () => {
  ...
  const getProjects = () => {
    ...
    const url = `http://localhost:5000/api/projects/iteration/${courseId}/published`;
  ...
  return (
    <>
      <Head>
        <title>Published Projects | Athena</title>
      </Head>
      <Box
        component="main"
        sx={{
...
PublishedProjects.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
