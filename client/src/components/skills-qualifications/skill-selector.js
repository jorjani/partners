import { Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography, Chip } from '@mui/material';
            ...
            >
                ...
                >
                    {options.map((skill, index) => {
                        return (
                            <Chip key={index} label={upperCase(skill.label) + " | " + skill.value} onDelete={handleDelete} />
                        )
                    })}
                </Paper>
            </Grid>
